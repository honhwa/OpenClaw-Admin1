export default {
  ...
  pages: {
    ...
    hermesMemory: {
      ...
      soul: {
        title: 'SOUL.md Personality Config',
        description: 'SOUL.md defines the core identity and personality of Hermes Agent, as the first part of the system prompt. Fully customizable for tone, style, and behavior guidelines.',
        emptyContent: 'No SOUL.md content yet. Click edit button to add personality config',
        notCreated: 'Not created',
        ...
        infoCard: {
          ...
          fileSize: 'File Size',
          role: 'Role',
          roleDesc: 'First slot in system prompt, defines agent core identity',
        },
      },
    },
    hermesSystem: {
